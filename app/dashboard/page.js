...
export default function about() {
  return (
    <nav class="sticky top-0 z-10 block w-full max-w-full px-4 py-2 text-white bg-white   shadow-md h-max  bg-opacity-50 backdrop-blur-2xl backdrop-saturate-200 lg:px-8 lg:py-4">
